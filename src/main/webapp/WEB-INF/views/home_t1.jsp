...
<link href="https://fonts.googleapis.com/css?family=Poppins:200,300,400,500,600,700"
	rel="stylesheet">
<link href="https://fonts.googleapis.com/css?family=Playfair+Display:400,400i,700,700i"
	rel="stylesheet">
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item"><a href="tour" class="nav-link"
						style="font-size: 20px">여행지 정보</a></li>
								...
								<div
									...
									<div class="wrap">
										<label for="#">도착일</label> <input type="text"
											class="form-control checkout_date" placeholder="도착일 선택">
									</div>
								</div>
							</div>
					...
					<div class="panel-body">
						<form action="user/login" method="post">
							<label>아이디</label> <input type="text" name="userid"
								placeholder="아이디 입력" required /> <br /> <label>비빌번호</label> <input
								type="password" name="pwd" placeholder="비밀번호 입력" required /> <br />
