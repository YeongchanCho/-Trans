            ...
            <div
                ...
                <div
                    ...
                    <div class="text">
                        ...
                        <h1 class="mb-4 bread" style="font-family: 맑은 고딕; font-size: 400%">여행 정보</h1>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="blog-entry align-self-stretch">
                            ...
                            <div class="text mt-3 d-block">
                                <h3 class="heading mt-3">
                                    <a href="#" style="font-family: 맑은 고딕">${tour.galTitle}</a>
                                </h3>
                                <div class="meta mb-3">

                                    <div>
                                        <a href="#">${tour.galPhotographyMonth}</a>
                                    </div>
                                    <div>
                                        <a href="#">${tour.galSearchKeyword}</a>
                                    </div>
                        ...
                        <div class="block-27">
                            <ul>
                                <c:if test="${pageMaker.prev}">
                                    <li><a
                                        href="tour${pageMaker.makeQuery(pageMaker.startPage - 1)}">이전</a></li>
                                </c:if>
                                ...
                                <c:forEach begin="${pageMaker.startPage}"
                                    ...
                                    <c:choose>
                                       <c:when test="${idx eq cri.page}">
                                           <li class="active"><span><a href="tour${pageMaker.makeQuery(idx)}">${idx}</a></span></li>
                                       </c:when>
                                       
                                       <c:otherwise>
                                           <li><a href="tour${pageMaker.makeQuery(idx)}">${idx}</a></li>
                                       </c:otherwise>                                   
                                    </c:choose>
                                </c:forEach>
                                ...
                                <c:if test="${pageMaker.next && pageMaker.endPage > 0}">
                                    <li><a
                                        href="tour${pageMaker.makeQuery(pageMaker.endPage + 1)}">다음</a></li>
                                </c:if>
                            </ul>
                        </div>
                    </div> 
