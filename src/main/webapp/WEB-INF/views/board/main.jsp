        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item"><a href="contact.html" class="nav-link">회원탈퇴</a></li>
            </ul>
          </div>
        </div>
      </nav>
      ...
      <div class="container">
        <div class="row no-gutters slider-text d-flex align-itemd-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
            <div class="text">
                <p class="breadcrumbs mb-2"><span class="mr-2"><a href="../">홈</a></span> <span>여행커뮤니티</span></p>
      ...
      <div class="container">
        ...
        <c:forEach var="board" items="${boardList}">
            ...
            <div class="blog-entry align-self-stretch">
              <a href="detail?bno=${board.bno}" class="block-20" style="background-image: url('../resources/images/image_1.jpg');">
              </a>
              <div class="text mt-3 d-block">
                <h3 class="heading mt-3"><a href="#" style="font-family: 맑은 고딕">${board.title}</a></h3>
                <div class="meta mb-3">
